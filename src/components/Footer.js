      ...
      <nav className=''>
        <ul className='py-8 lg:py-0 lg:flex lg:flex-col lg:flex-wrap lg:h-[130px] lg:text-left lg:mx-16'>
            {data.footerMenu.map(item => <li key={item} className='py-1 lg:mx-10'> 
                <a href="#" className='text-gray-light hover:text-lime-green hover:cursor-pointer transition'>{item}</a>
            </li> )}
        </ul>
      </nav>
      <div className='flex flex-col lg:ml-auto'>
        <button type='button' className='hover:brightness-105 my-2 px-6 py-3 text-white rounded-full bg-gradient-to-r from-lime-green to-bright-cyan self-center lg:self-end transition'>Request Invite</button>
